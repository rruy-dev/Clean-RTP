scoreboard players set @s rtp_whitelist 0
execute if data storage clean_rtp:whitelist {active:"On"} unless entity @s[scores={rtp_op=1..}] run scoreboard players set @s rtp_whitelist 1
execute if score @s rtp_whitelist matches 1 run function clean_rtp:checkwhitelist
