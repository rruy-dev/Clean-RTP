...
scoreboard objectives add rtp_range dummy
scoreboard objectives add rtp_netherymax dummy
...
execute unless score #rtp_rruy rtp_range matches 5000.. run scoreboard players set #rtp_rruy rtp_range 10000
execute unless score #rtp_rruy rtp_netherymax matches 126.. run scoreboard players set #rtp_rruy rtp_netherymax 126
